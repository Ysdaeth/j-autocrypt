...
Role of the encryptor is data encryption with a cryptographic key. It follows the [AlgorithmOutput](2.AlgorithmOutput.md)
...
Extends [Cryptographic](3.Cryptographic.md) interface to make it possible for Hasher implementations
to be grouped and return it's [AlgorithmIdentifier](1.AlgorithmIdentifier.md)