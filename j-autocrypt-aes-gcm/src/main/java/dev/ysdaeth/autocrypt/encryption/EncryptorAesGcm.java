...
public class EncryptorAesGcm implements Encryptor {
    ...
    public EncryptorAesGcm(AlgorithmIdentifier identifier){
     ...
     * @throws IllegalStateException when cipher instance could not be provided by the {@link java.security.Provider}
    ...
    private GCMParameterSpec generateGcmParams(){
        byte[] iv = new byte[12];
