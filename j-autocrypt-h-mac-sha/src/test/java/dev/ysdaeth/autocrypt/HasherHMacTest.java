...
class HasherHMacTest {
    ...
    static Stream<Arguments> hasherProviderIdentifierTest() throws Exception{
        ...
        return Stream.of(
          Arguments.of(HasherHMac.sha224(H_MAC_SHA224), keySha224, H_MAC_SHA224 ),
          Arguments.of(HasherHMac.sha256(H_MAC_SHA256), keySha256, H_MAC_SHA256 ),
          Arguments.of(HasherHMac.sha384(H_MAC_SHA384), keySha384, H_MAC_SHA384 ),
          Arguments.of(HasherHMac.sha512(H_MAC_SHA512), keySha512, H_MAC_SHA512 )
        );
    }
    ...
    static Stream<Arguments> hasherProviderForString_message() throws Exception {
        ...
        byte[] expected224 = encode("6qNxBggCoCJekeko5a/AradfxoCtpuJjRTnbnQ==", H_MAC_SHA224);

        Key keySha256 = createKey("uObmNkIkn3FNZoP7VGOQltbvnIz/efPcJRZyzJ1C/Mk=","HmacSHA256");
        byte[] expected256 = encode("h/uPSznmRUX8aR3uzaON/ZUB6X1K72Kz/AZzpHXYbRE=", H_MAC_SHA256);

        Key keySha384 = createKey("BoJcAhYMWP8ZRj286rTIHN+lNjj9DIIwlgNEiCpS0fHvBkzK8xGuD9PS2Ypajtw3","HmacSHA384");
        byte[] expected384 = encode("GwI36IgnOkquwwslgtSbBz282tWMfezO9JFuOg88SDPjefB2joLcf11FeAxJWS+1", H_MAC_SHA384);
        ...
        byte[] expected512 = encode("15b90iL9L489NDdUplCPS2mS0feWr+1sdWB3XwBLiuln/k0DXoF6/LqlPiL7kULNFYX2nGGu+9ZTuBZRc+8uwA==", H_MAC_SHA512);

        return Stream.of(
                Arguments.of(HasherHMac.sha224(H_MAC_SHA224), keySha224, expected224),
                Arguments.of(HasherHMac.sha256(H_MAC_SHA256), keySha256, expected256),
                Arguments.of(HasherHMac.sha384(H_MAC_SHA384), keySha384, expected384),
                Arguments.of(HasherHMac.sha512(H_MAC_SHA512), keySha512, expected512)
        );
    }
