...
class AesGcmTest {
    ...
    AesGcm aesGcm = new AesGcm(identifier);

    @Test
    void encrypt_shouldNotReturnRawData() throws Exception{
    ...
    @Test
    void decrypt_shouldReturnRawData() throws Exception {
    ...
    void decrypt_shouldReturnProperAlgorithmIdentifierBytes() throws Exception{
        ...
        Assertions.assertEquals(encoded[0],identifier.type(),"data bytes should be equal after decryption");
        Assertions.assertEquals(encoded[1],identifier.variant(), "data bytes should be equal after decryption");
    }

    @Test
    void decrypt_shouldThrowKeyExceptionOnWrongKey() throws Exception{
